...
Begin VB.Form frmTipoCargo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Buscar Tipo de Cargo"
   ClientHeight    =   4245
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6945
   Icon            =   "frmTipoCargo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4245
   ...
   End
End
Attribute VB_Name = "frmTipoCargo"
...
Screen.MousePointer = vbHourglass
    ...
    strSql = "exec Tllr_Buscar_TipoCargo '" & gstrIdEmpresa & "','" & Me.txtCodigo & "','" & Me.txtDescripcion & "','" & Me.cmbcoincidir.ListIndex + 1 & "'"
...
Dim iFila As Double
        ...
        Do While Not AdoPaso.EOF
            ...
            Paso = AdoPaso!Id_Tipo_Cargo
            Set Item = Me.lvwResultado.ListItems.Add(iFila)
            Item.SubItems(1) = ValorNulo(AdoPaso!Id_Tipo_Cargo)
            Item.SubItems(2) = ValorNulo(AdoPaso!Descripcion)
            iFila = iFila + 1
            AdoPaso.MoveNext
