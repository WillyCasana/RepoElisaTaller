...
Begin VB.Form frmMantenedorConceptosDyP 
   ...
   ClientTop       =   330
   ClientWidth     =   6750
   Icon            =   "frmMantenedorConceptosDyP.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   2025
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   360
      Width           =   6615
      Begin MSComCtl2.UpDown updOrden 
         Height          =   315
         Left            =   1920
         TabIndex        =   11
         Top             =   960
         ...
         Enabled         =   -1  'True
      End
      Begin VB.OptionButton optPintura 
         Caption         =   "Pintura"
         Height          =   195
         Left            =   4815
         TabIndex        =   10
         ...
         Width           =   900
      End
      Begin VB.OptionButton optDesabolladura 
         Caption         =   "Desabolladura"
         Height          =   195
         Left            =   2880
         TabIndex        =   9
         Top             =   1035
   ...
   Begin MSComctlLib.ImageList ImgBarraHerramienta 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":030A
            Key             =   "Crear"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":041C
            Key             =   "Editar"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":052E
            Key             =   "Grabar"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":0640
            Key             =   "Cancelar"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":0752
            Key             =   "Borrar"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":0864
            Key             =   "Buscar"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":0976
            Key             =   "Imprimir"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":0A88
            Key             =   "Cerrar"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":0B9A
            Key             =   "Ayuda"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":0CAC
            Key             =   "Primero"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":0DBE
            Key             =   "Anterior"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":0ED0
            Key             =   "Siguiente"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":0FE2
            Key             =   "Ultimo"
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":10F4
            Key             =   "Renovar"
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":1206
            Key             =   "SortAsc"
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":1318
            Key             =   "SortDesc"
         EndProperty
         BeginProperty ListImage17 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":142A
            Key             =   "Seleccion"
         EndProperty
         BeginProperty ListImage18 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":187C
            Key             =   "Seleccion1"
         EndProperty
         BeginProperty ListImage19 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantenedorConceptosDyP.frx":1CCE
            Key             =   "Copiar"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmMantenedorConceptosDyP"
...
Const mcNombreTabla = "Tllr_Concepto"
Const mcCampoCodigo = "Id_Concepto"
...
Private Sub optDesabolladura_Click()
If optDesabolladura.Value = True Then
    mstrD_P = "D"
Else
    mstrD_P = "P"
End If
...
Private Sub optPintura_Click()
If optPintura.Value = True Then
    mstrD_P = "P"
Else
    mstrD_P = "D"
End If
...
Private Sub Form_Activate()
    If mblnSW Then
        If Not Atributos("Glbl", "Tllr_10_0060", mblnAccesoCrear, mblnAccesoEditar, mblnAccesoBorrar, mblnAccesoImprimir) Then
...
Private Sub GrabarRegistro()
    ...
    If Me.Tag = "Crear" Then
        ...
        mstrSql = mstrSql & "usr_id, usr_fecha, D_P, Orden ) "
        mstrSql = mstrSql & " values ('" & Trim(txtCodigo) & "', '" & Trim(txtNombre) & "', '" & IIf(chkVigencia.Value = vbChecked, "S", "N") & "', "
        mstrSql = mstrSql & " '" & gstrUsuario & "', '" & Format(Date, "DD/MM/YYYY") & " " & Format(Time, "HH:MM:SS") & "',  '" & mstrD_P & "', " & updOrden.Value & " )"
    Else
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    Set frmMantenedorConceptosDyP = Nothing
