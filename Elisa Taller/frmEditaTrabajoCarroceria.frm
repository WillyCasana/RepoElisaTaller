...
Begin VB.Form frmEditaTrabajoCarroceria 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Edición Servicio de Carroceria"
   ClientHeight    =   3435
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6210
   Icon            =   "frmEditaTrabajoCarroceria.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3435
   ...
   Begin MSComctlLib.ImageList ImgBarraHerramienta 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":000C
            Key             =   "Grabar"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":011E
            Key             =   "Cancelar"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":0230
            Key             =   "Cerrar"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imlAux 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   19
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":0342
            Key             =   "Crear"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":0454
            Key             =   "Editar"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":0566
            Key             =   "Grabar"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":0678
            Key             =   "Cancelar"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":078A
            Key             =   "Borrar"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":089C
            Key             =   "Buscar"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":09AE
            Key             =   "Imprimir"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":0AC0
            Key             =   "Cerrar"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":0BD2
            Key             =   "Ayuda"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":0CE4
            Key             =   "Primero"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":0DF6
            Key             =   "Anterior"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":0F08
            Key             =   "Siguiente"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":101A
            Key             =   "Ultimo"
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":112C
            Key             =   "Renovar"
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":123E
            Key             =   "SortAsc"
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":1350
            Key             =   "SortDesc"
         EndProperty
         BeginProperty ListImage17 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":1462
            Key             =   "Seleccion"
         EndProperty
         BeginProperty ListImage18 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":18B4
            Key             =   "Seleccion1"
         EndProperty
         BeginProperty ListImage19 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditaTrabajoCarroceria.frx":1D06
            Key             =   "Copiar"
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmEditaTrabajoCarroceria"
...
With frmRecepcion.lvwServiciosCarroceria
    lblCodigo = .SelectedItem.SubItems(18)
    txtProveedor = .SelectedItem.SubItems(14)
    txtProveedor.Tag = .SelectedItem.SubItems(15)
    txtTipoTrabajo = .SelectedItem.SubItems(3)
    txtDescripcion = .SelectedItem.SubItems(2)
    txtPreUni = SacarFormatoValor(.SelectedItem.SubItems(6), "")
    txtCantidad = SacarFormatoValor(.SelectedItem.SubItems(5), "")
    ...
    txtSubTot = SacarFormatoValor(.SelectedItem.SubItems(16), "")
    txtTipoCargo = .SelectedItem.SubItems(12)
    txtTipoCargo.Tag = .SelectedItem.SubItems(13)
    'kjcv 17.09.18
    txtCC = .SelectedItem.SubItems(19)
...
With frmRecepcion.lvwServiciosCarroceria
    ...
    glsiItem.SubItems(2) = UCase(txtDescripcion)
    glsiItem.SubItems(3) = txtTipoTrabajo   'dtcPartePieza.Text
...
'    glsiItem.SubItems(5) = FormatoValor(txtPreUni, "", 0)
'    glsiItem.SubItems(6) = FormatoValor(txtCantidad, "", 1)
'    glsiItem.SubItems(7) = FormatoValor(txtPorcRec, "", 2)
'    glsiItem.SubItems(8) = FormatoValor(txtMtoRec, "", 0)
'    glsiItem.SubItems(9) = FormatoValor(txtPreFin, "", 0)
'    glsiItem.SubItems(10) = FormatoValor(txtSubTot, "", 0)
'    glsiItem.SubItems(11) = lblTipoCargo
'    glsiItem.SubItems(12) = lblTipoCargo.Tag
'    glsiItem.SubItems(13) = "N"
End With
End Sub

Private Sub cmdAceptarRep_Click()
    If txtTipoTrabajo = "" Then
        MsgBox "Debe Ingresar el tipo de Trabajo al que corresponde", vbExclamation, "D y P"
        txtTipoTrabajo.SetFocus
        Exit Sub
    End If
    If txtProveedor = "(Ninguno)" Or txtProveedor = "" Then
        If frmRecepcion.dtcGarantia.BoundText <> "PRE" Then
            MsgBox "Debe Ingresar el Proveedor", vbExclamation, "D y P"
...
If Button.Key = "Buscar" Then
    ...
    'gstrBusca = apfFormulario.BuscarRegistroClientes(Conexion, gstrBusca, mstrNombre)
    'lblProveedor.Tag = gstrBusca
...
'    txtSubTot = CCur(IIf(txtPreFin <> "", txtPreFin, "0")) * CDbl(IIf(txtCantidad <> "", txtCantidad, "0")) - CDbl(txtMtoDcto)
'Else
'    txtSubTot = "0"
'End If
...
If txtTipoCargo = "" Then
    txtTipoCargo.Tag = frmRecepcion.lvwServiciosCarroceria.SelectedItem.SubItems(13)
    txtTipoCargo = frmRecepcion.lvwServiciosCarroceria.SelectedItem.SubItems(12)
End If
